...
| `voter_params_get f` | X is field F from online account A as of the balance round: 320 rounds before the current round. Y is 1 if A had positive online algos in the balance round, else Y is 0 and X is a type specific zero-value |
