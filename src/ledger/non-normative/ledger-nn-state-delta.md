...
- `AccountStateDeltas`:\
A set of [`Account State Deltas`](../ledger-account-state.md), collecting changes to
accounts affected by the block, detailing how their states were modified.

- `KVMods`:\
A key-value map of modified entries in the [Key Value Store](../ledger-applications.md#keyvalue-stores),
