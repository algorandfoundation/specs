...
(function themes() {
    ...
    function set_theme(theme, store = true) {
        ...
        const enable = (stylesheet, enabled) => {
            if (stylesheet) {
        ...
        if (theme === 'dark') {
            enable(stylesheets.tomorrowNight, true);
            enable(stylesheets.highlight, false);
            ace_theme = 'ace/theme/tomorrow_night';
        } else {
            enable(stylesheets.tomorrowNight, false);
            enable(stylesheets.highlight, true);
